...
export default function GoogleLoginButton({ role = null }) {
 ...
 disabled={loading}
 className="w-full relative bg-card dark:bg-gray-800 text-gray-700 dark:text-gray-200 border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700"
 >
 {loading ? (
