...
"Content-Type":"application/json",
 ...
 <div>
 <h1 className="text-2xl font-bold tracking-tight text-foreground dark:text-slate-50">{currentUser.name}</h1>
 ...
 <Calendar className="h-4 w-4 text-slate-600 dark:text-muted-foreground" />
 </div>
 <div>
 ...
 <CardHeader className="flex flex-row items-center justify-between bg-background/50 border-b border-border">
 <div>
 ...
 className="bg-card border-blue-200 text-blue-600 hover:bg-blue-50"
 >
 ...
 <Button variant="ghost" size="sm" onClick={handleCancelEdit} className="text-slate-600 hover:bg-secondary">
 ...
 <span className="text-foreground">{currentUser.phone ||"Not provided"}</span>
 </div>
 )}
 </div>
 ...
 <span className="text-foreground">{currentUser.position ||"Business Owner"}</span>
 </div>
 )}
 </div>
 ...
 <span className="text-foreground">{currentUser.department ||"Not specified"}</span>
 </div>
 )}
 </div>
 </div>
 ...
 <Badge className="bg-slate-200 text-foreground hover:bg-slate-200 dark:bg-slate-700 dark:text-slate-300 border-0">
 ...
 required
 className="pr-10 border-border focus-visible:ring-blue-500"
 />
 <button
 type="button"
 ...
 className="text-slate-600 hover:bg-secondary"
 >
 Cancel
 </Button>
