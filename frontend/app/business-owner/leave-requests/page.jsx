...
export default function BusinessOwnerLeaveRequestsPage() {
 ...
 <p className="font-bold text-foreground">{leave.days} Days</p>
 </div>
 </div>
 <div className="bg-background p-2 rounded text-sm text-slate-600 italic border border-border">
"{leave.reason}"
 </div>
 </CardContent>
 <CardFooter className="bg-background/50 border-t gap-2 p-3">
 ...
 <TableHead className="cursor-pointer hover:bg-secondary transition-colors" onClick={() => requestSort("userRole")}><div className="flex items-center gap-1">Role <ArrowUpDown className="h-3 w-3 text-muted-foreground" /></div></TableHead>
 <TableHead className="cursor-pointer hover:bg-secondary transition-colors" onClick={() => requestSort("leaveType")}><div className="flex items-center gap-1">Type <ArrowUpDown className="h-3 w-3 text-muted-foreground" /></div></TableHead>
 <TableHead className="cursor-pointer hover:bg-secondary transition-colors" onClick={() => requestSort("startDate")}><div className="flex items-center gap-1">Dates <ArrowUpDown className="h-3 w-3 text-muted-foreground" /></div></TableHead>
 <TableHead className="cursor-pointer hover:bg-secondary transition-colors" onClick={() => requestSort("days")}><div className="flex items-center gap-1">Days <ArrowUpDown className="h-3 w-3 text-muted-foreground" /></div></TableHead>
 <TableHead className="cursor-pointer hover:bg-secondary transition-colors" onClick={() => requestSort("status")}><div className="flex items-center gap-1">Status <ArrowUpDown className="h-3 w-3 text-muted-foreground" /></div></TableHead>
 <TableHead>Reviewed By</TableHead>
 <TableHead className="cursor-pointer hover:bg-secondary transition-colors" onClick={() => requestSort("createdAt")}><div className="flex items-center gap-1">Applied On <ArrowUpDown className="h-3 w-3 text-muted-foreground" /></div></TableHead>
 </TableRow>
 </TableHeader>
 <TableBody>
 {allLoading ? (
