...
"flex flex-col items-center justify-center w-16 h-12 gap-1 rounded-xl transition-all",
 active 
 ?"text-blue-400" 
 :"text-muted-foreground hover:text-slate-300 hover:bg-slate-800"
 )}
 >
...
"flex items-center gap-3 px-4 py-3 rounded-lg transition-all group",
 ...
 >
 <Icon className={cn("h-5 w-5", active ?"text-white" :"text-muted-foreground group-hover:text-slate-300")} />
 ...
 <Button
 variant="ghost"
 className="w-full justify-start text-muted-foreground hover:text-red-400 hover:bg-slate-800"
 onClick={handleLogout}
 >
