...
export default function EmployeeProfilePage() {
 ...
 <h2 className="text-xl sm:text-2xl font-bold text-center text-foreground">{profileData.name}</h2>
 <p className="text-muted-foreground text-center mb-4 font-medium">{profileData.position}</p>
 ...
 <TabsTrigger
 value="details"
 className="data-[state=active]:bg-card data-[state=active]:text-blue-700 data-[state=active]:shadow-sm"
 >
 Personal Details
 </TabsTrigger>
 <TabsTrigger
