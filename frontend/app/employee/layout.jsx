...
export default function EmployeeLayout({ children }) {
 ...
 <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-card border-t border-border flex items-center overflow-x-auto gap-1 pb-safe px-2 py-2 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] no-scrollbar">
 {navLinks.map((link) => {
...
"flex flex-col items-center justify-center min-w-[64px] flex-shrink-0 h-12 gap-1 rounded-xl transition-all",
 ...
 <aside
 className={cn(
"hidden lg:flex fixed top-0 left-0 z-50 h-screen w-64 bg-card border-r border-sidebar-border transition-transform duration-300 ease-in-out"
 )}
 >
 ...
 <div>
 <h2 className="font-bold text-lg text-foreground tracking-tight">EMS PORTAL</h2>
