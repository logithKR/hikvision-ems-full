...
export default function EmployeeAttendancePage() {
 ...
 <Badge variant={isWorking ?"default" :"secondary"} className={isWorking ?"bg-blue-600" :"bg-slate-200 text-foreground"}>
 ...
 <TableCell>
 <Badge variant={record.checkOut ?"default" :"secondary"} className={record.checkOut ?"bg-blue-100 text-blue-800 hover:bg-blue-100" :"bg-secondary text-foreground hover:bg-secondary"}>
