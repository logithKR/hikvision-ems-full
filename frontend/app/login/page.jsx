...
export default function UnifiedLoginPage() {
 ...
 className="pl-10 h-12 border-border focus:border-blue-500 focus:ring-blue-500 rounded-xl"
 ...
 disabled={loading}
 className="w-full h-12 bg-card hover:bg-background text-foreground border-border rounded-xl font-medium shadow-sm flex items-center justify-center gap-3 transition-all"
 >
 {loading ? (
 ...
 <p className="text-sm text-slate-600 bg-background py-2 px-3 rounded-lg border border-border inline-block mb-2">
 Signed in as <span className="font-bold text-foreground">{email}</span>
 </p>
 <h3 className="text-lg font-bold text-foreground mt-2">Select your Workspace</h3>
 </div>
 ...
 disabled={loading}
 className="w-full p-4 border border-border rounded-xl flex items-center justify-between hover:border-blue-500 hover:bg-blue-50 transition-all group text-left bg-card"
 >
 <div className="flex flex-col">
 <span className="font-bold text-foreground group-hover:text-blue-700">
 {org.name} <span className="text-muted-foreground font-normal text-xs ml-1">(ID: {org.id})</span>
 </span>
 <span className="text-xs text-muted-foreground font-medium capitalize mt-1 flex items-center gap-1.5">
 ...
 disabled={loading}
 className="mt-6 text-sm text-muted-foreground hover:text-foreground font-medium w-full text-center py-2"
 >
 ...
 <div className="text-center">
 <p className="text-sm text-slate-600 bg-background py-2 px-3 rounded-lg border border-border inline-block mb-2">
 Workspace: <span className="font-bold text-foreground">
 {workspaces.find(w => w.id === selectedOrgId)?.name || 'System'}
 </span>
 </p>
 <h3 className="text-lg font-bold text-foreground mt-2">Enter your Password</h3>
 </div>
 ...
 className="pl-10 pr-10 h-12 border-border focus:border-blue-500 focus:ring-blue-500 rounded-xl"
 placeholder="••••••••"
 disabled={loading}
 required
 />
 ...
 className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-slate-600 transition-colors p-1"
 >
